...
use device_state::windows::winapi::shared::windef::POINT;
use device_state::windows::winapi::um::winuser;
use device_state::windows::winapi::um::winuser::{GetAsyncKeyState, GetCursorPos};
